...
void PromptReco(string fName = "nope.root",string outFile="save.root"){
    UInt_t stub=0;
    ...
    TH2I ** stubInfoPerTdc = new TH2I*[13];
    for (int i=0; i<13; i++) stubInfoPerTdc[i] = new TH2I(Form("stubInfo_tdc%i",i),Form("Stub information Tdc %i", i),4,0,4,16,0,16);
    ...
    for (int i =0; i<t->GetEntries(); i++){
        ...
        if (tdc<=12) fillStubInfo(stub,stubSim,stubInfoPerTdc[(int)tdc]);
        if(stub)nStub++;
    ...
    for (int itdc=0; itdc<13; itdc++){
      stubInfoPerTdc[itdc]->GetXaxis()->SetBinLabel(1,"No stub + no Sim");
      stubInfoPerTdc[itdc]->GetXaxis()->SetBinLabel(2,"No Stub + Sim");
      stubInfoPerTdc[itdc]->GetXaxis()->SetBinLabel(3,"Stub + no Sim");
      stubInfoPerTdc[itdc]->GetXaxis()->SetBinLabel(4,"Stub + Sim");
      stubInfoPerTdc[itdc]->GetYaxis()->SetTitle("CBC #");
      stubInfoPerTdc[itdc]->Write();
    }
