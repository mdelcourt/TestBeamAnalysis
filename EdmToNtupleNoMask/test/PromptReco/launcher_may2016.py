...
parser.add_option("-m","--min",dest="runMin",default="100",help="First run to process")
parser.add_option("-M","--Max",dest="runMax",default="-1",help="Last run to process")
...
NAS="/cmsuptrackernas/PromptRecoData/May2016"
